    ...
    public class MultiRegionTrackingTests
    {
        ...
        private static void PreparePages(IMultiRegionHandle handle, int pageCount, ulong address = 0)
        {
            ...
            RandomOrder(random, Enumerable.Range(0, pageCount).ToList(), (i) =>
            {
                ...
                Assert.That((ulong)i * PageSize + address, Is.EqualTo(resultAddress));
            });
        }
        ...
        public void SmartRegionTracking()
        {
            ...
            handle.QueryModified((address, size) =>
            {
                ...
                Assert.That((ulong)(PageSize * region), Is.EqualTo(size));
        ...
        public void InheritHandles()
        {
            ...
            Assert.That(combinedHandles.ElementAt(3), Is.EqualTo(handleGroups[0].ElementAt(0)));
            Assert.That(combinedHandles.ElementAt(4), Is.EqualTo(handleGroups[0].ElementAt(1)));
            Assert.That(combinedHandles.ElementAt(5), Is.EqualTo(handleGroups[0].ElementAt(2)));

            Assert.That(combinedHandles.ElementAt(8), Is.EqualTo(singlePages[0]));
            Assert.That(combinedHandles.ElementAt(9), Is.EqualTo(singlePages[1]));
            Assert.That(combinedHandles.ElementAt(10), Is.EqualTo(singlePages[2]));
        }
        ...
        public void PreciseAction()
        {
            ...
            Assert.That(new bool[] { true, false, false }, Is.EqualTo(pagesModified));
        }
    }
}
