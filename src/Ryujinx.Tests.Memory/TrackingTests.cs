...
namespace Ryujinx.Tests.Memory
{
    public class TrackingTests
    {
        ...
        public void SingleRegion()
        {
            ...
            Assert.That((0UL, 4UL), Is.EqualTo(readTrackingTriggered)); // Read action was triggered.
        ...
        public void OverlappingRegions()
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                Assert.That(((ulong)i * PageSize, 1UL), Is.EqualTo(readTrackingTriggeredAll)); // Triggered read tracking
                for (int j = 0; j < 16; j++)
                {
                    if (j == i)
                    {
        ...
        public void ReadActionThreadConsumption()
        {
            ...
            Assert.That(triggeredCount + 1, Is.EqualTo(registeredCount));
        }
        ...
        public void DisposeHandles()
        {
            ...
            Assert.That(_tracking.GetRegionCount(), Is.EqualTo(1));
            ...
            Assert.That(_tracking.GetRegionCount(), Is.EqualTo(3));
        ...
        public void ReadAndWriteProtection()
        {
            ...
            {
                Assert.That((va, size), Is.EqualTo((0, PageSize))); // Should protect the exact region all the operations use.
            ...
            Assert.That(protection, Is.EqualTo(MemoryPermission.ReadAndWrite));
            ...
            Assert.That(protection, Is.EqualTo(MemoryPermission.Read));
            ...
            Assert.That(protection, Is.EqualTo(MemoryPermission.None));
            ...
            Assert.That(protection, Is.EqualTo(MemoryPermission.Read)); // Write protection is still present.
            ...
            Assert.That(protection, Is.EqualTo(MemoryPermission.ReadAndWrite)); // All protection is now be removed from the memory.
        ...
        public void PreciseAction()
        {
            ...
            Assert.That((0UL, 4UL, false), Is.EqualTo(preciseTriggered)); // Precise action was triggered.
            ...
            Assert.That((0UL, 4UL, true), Is.EqualTo(preciseTriggered)); // Precise action was triggered.
            ...
            Assert.That((4UL, 4UL, true), Is.EqualTo(preciseTriggered)); // Precise action was triggered even though handle was dirty.
            ...
            Assert.That((8UL, 4UL), Is.EqualTo(readTrackingTriggered)); // Read action triggered, as precise action returned false.
            ...
            Assert.That((8UL, 4UL, true), Is.EqualTo(preciseTriggered)); // Precise action was triggered.
        }
    }
}
