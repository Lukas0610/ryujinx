...
namespace Ryujinx.Tests.Audio.Renderer.Server
{
    public class BehaviourContextTests
    {
        ...
        public void TestRevision1()
        {
            ...
            Assert.That(behaviourContext.GetAudioRendererProcessingTimeLimit(), Is.EqualTo(0.70f));
            Assert.That(behaviourContext.GetCommandProcessingTimeEstimatorVersion(), Is.EqualTo(1));
            Assert.That(behaviourContext.GetPerformanceMetricsDataFormat(), Is.EqualTo(1));
        }
        ...
        public void TestRevision4()
        {
            ...
            Assert.That(behaviourContext.GetAudioRendererProcessingTimeLimit(), Is.EqualTo(0.75f));
            Assert.That(behaviourContext.GetCommandProcessingTimeEstimatorVersion(), Is.EqualTo(1));
            Assert.That(behaviourContext.GetPerformanceMetricsDataFormat(), Is.EqualTo(1));
        }
        ...
        public void TestRevision5()
        {
            ...
            Assert.That(behaviourContext.GetAudioRendererProcessingTimeLimit(), Is.EqualTo(0.80f));
            Assert.That(behaviourContext.GetCommandProcessingTimeEstimatorVersion(), Is.EqualTo(2));
            Assert.That(behaviourContext.GetPerformanceMetricsDataFormat(), Is.EqualTo(2));
        }
        ...
        public void TestRevision8()
        {
            ...
            Assert.That(behaviourContext.GetAudioRendererProcessingTimeLimit(), Is.EqualTo(0.80f));
            Assert.That(behaviourContext.GetCommandProcessingTimeEstimatorVersion(), Is.EqualTo(3));
            Assert.That(behaviourContext.GetPerformanceMetricsDataFormat(), Is.EqualTo(2));
        }
        ...
        public void TestRevision10()
        {
            ...
            Assert.That(behaviourContext.GetAudioRendererProcessingTimeLimit(), Is.EqualTo(0.80f));
            Assert.That(behaviourContext.GetCommandProcessingTimeEstimatorVersion(), Is.EqualTo(4));
            Assert.That(behaviourContext.GetPerformanceMetricsDataFormat(), Is.EqualTo(2));
        }
        ...
        public void TestRevision11()
        {
            ...
            Assert.That(behaviourContext.GetAudioRendererProcessingTimeLimit(), Is.EqualTo(0.80f));
            Assert.That(behaviourContext.GetCommandProcessingTimeEstimatorVersion(), Is.EqualTo(5));
            Assert.That(behaviourContext.GetPerformanceMetricsDataFormat(), Is.EqualTo(2));
        }
